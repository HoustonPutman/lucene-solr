...
public class BottomFunctionTest extends SolrTestCaseJ4 {
  ...
  public void multiValueDateTest() throws ParseException {
    ...
    assertEquals(ExtractionDateUtil.parseDate("1800-12-31T11:30:50Z"), func.getDate());
    assertTrue(func.exists());
  }
  ...
  public void multipleSingleValueDateTest() throws ParseException {
    ...
    assertEquals(ExtractionDateUtil.parseDate("1850-05-03T10:30:50Z"), func.getDate());
    assertTrue(func.exists());
    ...
    val4.setValue("1850-05-03T10:30:50Z").setExists(true);
    assertEquals(ExtractionDateUtil.parseDate("1700-05-03T10:30:50Z"), func.getDate());
    assertTrue(func.exists());
  }
